...
- Players went to nearby motel because they'd been awake since fighting Ji-toh
## Outcomes
  - Tarboo in custody
...
- The Dug who initially went along with the parties ruse that they were bringing him drugs threatens the crew with security droids
## Outcomes
  - Tarboo reunited
  - Players level up
...
key_characters:
  ...
  - "[[Gamorrean Guard]]"
outcomes:
  - BA-136 is defeated; T0-ME is destroyed (later repaired).
  - R1-J8 hires the mercenaries to find a journalist and publish the holorecord.
hooks:
  - Where to publish?
  - SIS retaliation risk
  - Hutt response after guards die
---
...
key_characters:
  ...
  - "[[Weequay Thug]]"
outcomes:
  - Q'russ is killed (revival possible hook).
  - Party escapes with holorecord copy delivered to Tia Rell.
hooks:
  - Tia Rell betrayal fallout
  - Galen Zullari pursuit
  - Public release consequences
---
